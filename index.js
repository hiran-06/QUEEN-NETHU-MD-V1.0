...
async function connectToWA() {
  ...
  console.log("Connecting ❤️𝑸𝑼𝑬𝑬𝑵-𝑵𝑬𝑻𝑯𝑼❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️𝑸𝑼𝑬𝑬𝑵-𝑵𝑬𝑻𝑯𝑼❤️ installed successful ✅");
      console.log("❤️𝑸𝑼𝑬𝑬𝑵-𝑵𝑬𝑻𝑯𝑼❤️ connected to whatsapp ✅");

      let up = `❤️𝑸𝑼𝑬𝑬𝑵-𝑵𝑬𝑻𝑯𝑼❤️ connected successful ✅`;
      let up1 = `Hello Liyo, I made bot successful`;

      robin.sendMessage(ownerNumber + "@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Queen-Nethu-MDV/Bot-Help/refs/heads/main/IMG-20250216-WA0140.jpg`,
        },
        caption: up,
      });
      robin.sendMessage("94779702531@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Queen-Nethu-MDV/Bot-Help/refs/heads/main/IMG-20250216-WA0140.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, ❤️𝑸𝑼𝑬𝑬𝑵-𝑵𝑬𝑻𝑯𝑼❤️ started✅");
});
app.listen(port, () =>
